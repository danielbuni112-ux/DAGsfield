...
const LOGOS = ['Nike', 'Apple', 'Amazon', 'Google', 'Meta', 'Shopify'];
...
export function CommercialPage() {
  ...
  container.innerHTML = `
    <section class="relative overflow-hidden">
      <div class="absolute inset-0 bg-gradient-to-br from-violet-900/20 via-black to-purple-900/20"></div>
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div class="flex justify-center mb-8">
          <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
            ...
            <span class="text-sm text-gray-300">Professional Product Photography</span>
          </div>
        </div>
        
        <h1 class="text-5xl sm:text-6xl lg:text-7xl font-bold text-center text-white tracking-tight mb-6">
          <span class="bg-gradient-to-r from-white via-violet-200 to-purple-200 bg-clip-text text-transparent">
            Commercial
          </span>
        </h1>
        
        <p class="text-xl sm:text-2xl text-gray-400 text-center max-w-3xl mx-auto mb-10">
          AI product photography, ads, and commercial content
        </p>
        
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          <button class="start-btn group relative px-8 py-4 bg-white text-black font-bold rounded-full text-lg hover:bg-gray-100 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-violet-500/25">
        ...
        <div class="relative max-w-4xl mx-auto">
          <div class="absolute -inset-1 bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 rounded-2xl blur opacity-30"></div>
          <div class="relative bg-gray-900 rounded-2xl overflow-hidden border border-white/10" style="aspect-ratio: 16/9;">
            <div class="absolute inset-0 flex items-center justify-center">
              <div class="text-center">
                <div class="w-24 h-24 mx-auto mb-4 rounded-full bg-gradient-to-br from-violet-500 to-purple-500 flex items-center justify-center">
                ...
                <p class="text-gray-500 text-sm">Commercial Photography</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="py-24">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="text-3xl lg:text-4xl font-bold text-white mb-4">Professional Results</h2>
          <p class="text-xl text-gray-400 max-w-2xl mx-auto">Create commercial content that converts</p>
        </div>
        
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ${FEATURES.map(f => `
            <div class="group p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-violet-500/30 transition-all duration-300 hover:bg-white/[0.07]">
    ...
    <section class="py-24 bg-white/[0.02]">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="text-3xl lg:text-4xl font-bold text-white mb-4">Scene Presets</h2>
          <p class="text-xl text-gray-400 max-w-2xl mx-auto">Professional backgrounds for any product</p>
        </div>
        
        <div class="flex flex-wrap justify-center gap-3">
          ${SCENE_PRESETS.map(scene => `
            <span class="px-6 py-3 rounded-full bg-white/5 border border-white/10 text-white font-medium hover:bg-white/10 hover:border-violet-500/50 transition-all cursor-pointer">${scene}</span>
          `).join('')}
        </div>
      </div>
    </section>
    ...
    <section class="py-24">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="text-3xl lg:text-4xl font-bold text-white mb-4">Export Formats</h2>
          <p class="text-xl text-gray-400 max-w-2xl mx-auto">Optimized for all advertising platforms</p>
        </div>
        
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          ${FORMAT_PRESETS.map(fmt => `
            <div class="format-card group p-6 rounded-xl bg-white/5 border border-white/10 hover:border-violet-500/50 transition-all duration-300 text-center cursor-pointer">
    ...
    <section class="py-12 border-y border-white/5">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p class="text-center text-sm text-gray-500 mb-8">TRUSTED BY BRANDS WORLDWIDE</p>
    ...
    <section class="py-24">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-600 via-purple-600 to-fuchsia-600 p-1">
          ...
          <div class="relative bg-black/40 backdrop-blur-xl rounded-3xl p-12 text-center">
            <h2 class="text-3xl lg:text-4xl font-bold text-white mb-4">Create Commercials</h2>
            <p class="text-xl text-white/80 mb-8 max-w-xl mx-auto">Professional product photography at scale</p>
